...
cover: "https://github.com/UtkarshVerma/blog/blob/source/images/netjsonconfig/django2.png"
draft: false
---
...
![develop failed](https://github.com/UtkarshVerma/blog/blob/source/static/images/netjsonconfig/django2.png)
...
![setup.py fix](https://github.com/UtkarshVerma/blog/blob/source/static/images/netjsonconfig/my-fix.png)
...
![Older Django being downloaded](https://github.com/UtkarshVerma/blog/blob/source/static/images/netjsonconfig/django-v-fixed.png)

![Successful!](https://github.com/UtkarshVerma/blog/blob/source/static/images/netjsonconfig/Success!.png)
...
![Migrate](https://github.com/UtkarshVerma/blog/blob/source/static/images/netjsonconfig/migrate.png)

After that, there was the superuser creation using `./manage.py createsuperuser`.

![Superuser creation](https://github.com/UtkarshVerma/blog/blob/source/static/images/netjsonconfig/superuser.png)

# Running the Test Server
I started the test server using `./manage.py runserver` and it was successful. 

![Server Up and Running!](https://github.com/UtkarshVerma/blog/blob/source/static/images/netjsonconfig/up-and-running.png)

I could also now visit the server at [http://localhost:8000/admin](http://localhost/admin).   

![Logged In](https://github.com/UtkarshVerma/blog/blob/source/static/images/netjsonconfig/logged-in.png)
